...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=matt-dres&repo=another-tanzu-java-web-app",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=matt-dres&repo=another-tanzu-java-web-app'
